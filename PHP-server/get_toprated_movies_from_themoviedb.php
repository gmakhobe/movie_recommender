<?php
/**
 * Get top rated movies from https://www.themoviedb.org/
 */

include("get_api_key.php");
include("themoviedb_requests.php");

$url_1 = "https://api.themoviedb.org/3/movie/top_rated?language=en-US&page=1&api_key=$themoviedb_apikey";
$url_2 = "https://api.themoviedb.org/3/movie/top_rated?language=en-US&page=2&api_key=$themoviedb_apikey";
$url_3 = "https://api.themoviedb.org/3/movie/top_rated?language=en-US&page=3&api_key=$themoviedb_apikey";
